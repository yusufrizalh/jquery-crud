...
<body>
        ...
        <div class="row">
            <div class="col-md-12 mt-3">
                ...
                <div class="float-right">
                    <a href="javascript:void(0);" class="btn btn-success" data-type="add" 
                        data-toggle="modal" data-target="#modalUserAddEdit">
    ...
    <script>
        ...
        // mengirim permintaan operasional CRUD ke server
        ...
        // munculkan data tables (pagination, searching)
